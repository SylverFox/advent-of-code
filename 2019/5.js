...
class Program {
    ...
    step() {
        ...
        if (this.debug) console.log(`ip: ${this.ip}, opcode: ${opcode}, mode: ${mode}, base: ${this.relativeBase}`)
        ...
        if (this.debug) console.log('program:', this.programData.join(','), 'output:', this.output.join(','))
    }
