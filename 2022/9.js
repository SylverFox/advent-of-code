export default function (input) {
    ...
    let output = knots[knots.length - 1].visited.filter((e, i, a) => a.indexOf(e) === i)
    ...
    output = knots[knots.length - 1].visited.filter((e, i, a) => a.indexOf(e) === i)
